...
const Filters = ({ setFilters, filters, pages }) => {
  ...
  return (
    <div className="flex h-auto w-full flex-col pt-20">
    
    <div className="w-96 mr-auto ml-2 sm:ml-4 md:ml-4 xl:ml-12">
    <div
      div
    ...
    <ReactPaginate
      ...
      className="mt-2 flex w-auto mr-auto ml-2 sm:ml-4 md:ml-4 xl:ml-12 flex-wrap items-center justify-center "
      />
    
    <div className="flex mt-4 ml-auto mr-2 sm:mr-4 md:mr-4 xl:mr-12">
    <div className="dropdown relative inline-block">
    <button className="inline-flex items-center rounded bg-gray-300 py-2 px-12 font-semibold text-gray-700 md:px-12 mr-2">
    ...
    <p
    onClick={() =>
      setFilters({ ...filters, ordering: 'downloads' })
    }
    className="whitespace-no-wrap block cursor-pointer rounded-t bg-gray-200 py-2 px-4 hover:bg-gray-400"
    >
    ...
    className="whitespace-no-wrap block cursor-pointer bg-gray-200 py-2 px-4 hover:bg-gray-400"
    >
    Downloads - Ascending{' '}
    </p>
    </li>
            <li>
            <p
            onClick={() => setFilters({ ...filters, ordering: 'title' })}
            className="whitespace-no-wrap block cursor-pointer rounded-b bg-gray-200 py-2 px-4 hover:bg-gray-400"
            >
            Title - Descending
            </p>
            </li>
            ...
            <select
            className="block rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 outline-none "
            name="languages"
            onChange={(e) =>
